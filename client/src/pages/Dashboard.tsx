...
import type { ActivityEntry, FoodEntry } from "..";
...
<div className="dashboard-grid">
    ...
    {/* Goal Card */}
    {user && (// This card will span both column on large screen
...
{user.height && (
    ...
    {/* Quick Summary */}
   <Card>
    <h3 className="font-semibold text-slate-800 dark:text-white mb-4">Todays Summary</h3>
